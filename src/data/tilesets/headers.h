...
const struct Tileset gTileset_Johto =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .numTiles = NUM_TILES_IN_PRIMARY_FRLG,
    ...
    .metatileAttributes = gMetatileAttributes_Johto,
    .callback = NULL,
};
...
const struct Tileset gTileset_Route35 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .dontUsePal7 = TRUE,
    ...
    .metatileAttributes = gMetatileAttributes_Route35,
    .callback = NULL,
};
...
const struct Tileset gTileset_Cave_Johto =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .dontUsePal7 = TRUE,
    ...
    .metatileAttributes = gMetatileAttributes_Cave_Johto,
    .callback = NULL,
};
